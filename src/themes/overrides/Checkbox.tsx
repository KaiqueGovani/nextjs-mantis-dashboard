...
import { ColorProps, FontSizeProps } from 'types/extended';

// ==============================|| RADIO - COLORS ||============================== //

function getColorStyle({ color, theme }: { color: ColorProps; theme: Theme }) {
...
function getSizeStyle(size: FontSizeProps) {
  switch (size) {
    case 'small':
...
function checkboxStyle(size: FontSizeProps) {
